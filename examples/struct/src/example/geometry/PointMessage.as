...
package example.geometry
{
    ...
    public final class PointMessage
    {
        ...
        public static function packInto(source:PointMessage, context:as3flatbuffers.PackContext):uint
        {
            ...
            as3flatbuffers.Pack.ensure(context, 25);
        ...
        /** Replace dst with packed bytes. Writes little-endian without changing dst.endian. Returns dst at position zero. */
        public static function packSizePrefixed(source:PointMessage, dst:flash.utils.ByteArray):flash.utils.ByteArray
        {
            if (!source || !dst)
                throw new ArgumentError("Source and destination must be non-null");
        ...
        public static function unpackSizePrefixed(bytes:flash.utils.ByteArray, destination:PointMessage = null, offset:uint = 0):PointMessage
        {
            const context:as3flatbuffers.UnpackContext = UNPACK;
