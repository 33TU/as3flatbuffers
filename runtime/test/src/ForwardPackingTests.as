    ...
    public final class ForwardPackingTests
    {
        public static function run(check:Function):void
        {
            ...
            rejects(function():void
                ...
                }, check, "Packing rejects missing 64-bit values");
            ...
            rejects(function():void
                {
                    Point.pack(null, other);
                }, check, "Null source rejected before attaching");
            check(other.length == oldLength, "Null source leaves destination untouched");
            rejects(function():void
                {
                    Point.pack(point, null);
                }, check, "Null destination rejected");
            ...
            rejects(function():void
                {
                    Frame.pack(frame, dst);
                }, check, "Struct rejects null signed words");
            ...
            rejects(function():void
                {
                    Frame.pack(frame, dst);
                }, check, "Struct rejects null unsigned words");
            ...
            rejects(function():void
                {
                    Frame.pack(frame, dst);
                }, check, "Struct rejects null nested struct");
            ...
            rejects(function():void
                ...
                }, check, "Flattened struct rejects null child");
            ...
            rejects(function():void
                {
                    Envelope.pack(envelope, dst);
                }, check, "Flattened struct rejects null grandchild");
            ...
            rejects(function():void
                {
                    Envelope.pack(envelope, dst);
                }, check, "Flattened struct rejects nested null words");
