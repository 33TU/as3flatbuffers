...
package bench.data
{
    ...
    public final class VectorScalars
    {
        ...
        /** Replace dst with packed bytes. Writes little-endian without changing dst.endian. Returns dst at position zero. */
        public static function packSizePrefixed(source:VectorScalars, dst:flash.utils.ByteArray):flash.utils.ByteArray
        {
            if (!source || !dst)
                throw new ArgumentError("Source and destination must be non-null");
        ...
        public static function unpackSizePrefixed(bytes:flash.utils.ByteArray, destination:VectorScalars = null, offset:uint = 0):VectorScalars
        {
            const context:as3flatbuffers.UnpackContext = UNPACK;
